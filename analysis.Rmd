...
webpages we are intested in share very simular URL structure. This allows us to 
rip through each year collecting the table elements and saving into dataframes for 
easy analysis. 
